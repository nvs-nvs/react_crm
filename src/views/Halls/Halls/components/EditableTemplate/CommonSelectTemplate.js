...
class CommonSelectTemplate extends Component{
    ...
    onUpdate = (e) => {
        ...
        axios(`${config.api_url}/api/halls/update`, {
            ...
            data: {
                updatedRow: {...this.state.row, template_name : this.state.currentValue}
            },
        }).then(response => {
                this.setState({
                    edit: false,
                ...
                this.props.updateTable({...this.state.row, template_name : this.state.currentValue}, this.props.cellInfo.index);
            },
            (error) => {
                this.setState({
                    edit: false,
